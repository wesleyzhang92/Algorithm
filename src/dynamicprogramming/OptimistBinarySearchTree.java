...
/**
 * Created by wesley on 2016/10/18.
 */
public class OptimistBinarySearchTree {
    private double[] p;
    private double[] q;
    private int n;
    private double[][] e;
    ...
    public OptimistBinarySearchTree(double[] p, double[] q, int n) {
        this.p = p;
        this.q = q;
        this.n = n;
    ...
    public static void main(String[] args) {
        ...
        OptimistBinarySearchTree bst = new OptimistBinarySearchTree(p, q, 5);
        bst.calculate();
    }
