package IntroductiontoAlgorithm.random;
...
public class HireAssistant {
    ...
    /**
     * Permute interviewees, by IntroductiontoAlgorithm.random priorities
     */
    ...
    /**
     * Generate uniform IntroductiontoAlgorithm.random permutation 均匀的随机排列
     */
    public void randomInPlace() {
        ...
        for (i = 0; i < sum; i++) {
            int j = (int) (Math.random() * (sum - i) + i);// IntroductiontoAlgorithm.random int i~ (n - 1)
