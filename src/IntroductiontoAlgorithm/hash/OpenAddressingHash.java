package IntroductiontoAlgorithm.hash;
...
public class OpenAddressingHash {
    ...
    public int hash_insert1(int T[], int m, int k) {
        ...
        System.out.println("IntroductiontoAlgorithm.hash table overflow");
        return -1;
    }
    ...
    public static void main(String[] args){
        ...
        int[] T=new int[11];
        System.out.println("Linear IntroductiontoAlgorithm.hash");
        for (int i=0;i<11;i++)
        {
            T[i]=-1;
        }
